...
func articlelistHandler(w http.ResponseWriter, r *http.Request) {
	...
	class="inline-block w-full rounded bg-lime-500 m-1 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3">{{.Title}} - {{.Author}}</button></form></li>
		{{end}}`)
