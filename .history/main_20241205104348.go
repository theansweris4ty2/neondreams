...
func selectBookHandler(w http.ResponseWriter, r *http.Request) {
	...
	htmlStr := fmt.Sprintf("<li class='inline-block w-full rounded bg-orange-500 px-6 pb-2.5 pt-2.5 text-lg font-large uppercase leading-normal text-white m-2'> %s - %s</li>", t, a)
